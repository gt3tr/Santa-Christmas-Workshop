  ...
  async ButtonClick(event: cc.Event.EventCustom) {
    ...
    if (node.parent.name == "1") {
      ...
      this.Particle.setPosition(
        this.Particle.parent.convertToNodeSpaceAR(Items.parent.convertToWorldSpaceAR(Items.position))
      );
      ...
      this.Particle.setPosition(
        this.Particle.parent.convertToNodeSpaceAR(Frame.parent.convertToWorldSpaceAR(Frame.position))
      );
